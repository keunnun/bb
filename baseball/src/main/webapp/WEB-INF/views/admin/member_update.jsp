...
<c:if test="${userid=='admin'}">   
 <div id="content" style="margin:30px 0px 40px 0px;">
  <form name="upd" method="post" action="member_update_ok">
   <table width="700" align="center">
    <caption> <h3> 회원 정보 수정 </h3></caption>
     <input type="hidden" name="mid" value="${mdto.mid}">
    <tr>
      <td width="140" style="padding-left:120px;"> 이름 </td>
    ...
    <tr>
      <td style="padding-left:120px;"> 우편번호 </td>
    ...
    <tr>
      <td style="padding-left:120px;"> 상세주소 </td>
      <td> <input type="text" name="juso3" value="${mdto.juso3}"  size="30"></td>
    </tr>
    <tr>
      <td style="padding-left:120px;"> 포인트 </td>
      <td> <input type="text" name="point" value="${mdto.point}"  size="30"></td>
    </tr>
    <tr>
